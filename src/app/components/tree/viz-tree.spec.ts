...
import { VIZTree, VIZTreeNode } from './viz-tree';
...
@Component({
	...
	<viz-tree class="files" [value]="filesTree7" draggableNodes="true" droppableNodes="true" droppableScope="files" draggableScope="server2"></viz-tree>
	<viz-tree class="server1" [value]="filesTree8" draggableNodes="true" droppableNodes="true" droppableScope="server1" draggableScope="files"></viz-tree>
	<viz-tree class="server2" [value]="filesTree9" draggableNodes="true" droppableNodes="true" droppableScope="server2" draggableScope="server1"></viz-tree>
	`
  })
  class TestVIZTreeComponent implements OnInit {
...
describe('Tree', () => {
	...
	let tree: VIZTree;
	let filesTree: VIZTree;
	let server1Tree: VIZTree;
	let server2Tree: VIZTree;
	let contextMenu: ContextMenu;
	let testComponent: TestVIZTreeComponent;
	let fixture: ComponentFixture<TestVIZTreeComponent>;
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			...
			declarations: [
				...
				ContextMenu,
				ContextMenuSub,
				TestVIZTreeComponent
			],
			providers: [TreeDragDropService, ContextMenuService]
		});

		fixture = TestBed.createComponent(TestVIZTreeComponent);
	...
	it('should call toggle and expand clicked row', () => {
		...
		const documentsNode = treeNodes[0].componentInstance as VIZTreeNode;
